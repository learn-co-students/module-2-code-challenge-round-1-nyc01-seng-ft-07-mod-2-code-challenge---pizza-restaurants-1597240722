...
15.times do
  RestaurantPizza.create(restaurant_id: Restaurant.all.sample.id, pizza_id: Pizza.all.sample.id, price: rand(1..10))
end


p Restaurant.all.count
p Pizza.all.count
p RestaurantPizza.all.count
