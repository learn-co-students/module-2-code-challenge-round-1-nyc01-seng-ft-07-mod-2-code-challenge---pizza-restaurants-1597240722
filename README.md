...
<!-- Each Restaurant can have many Pizzas and  -->
<!-- each Pizza can belong to multiple Restaurants.  -->
<!-- Each Restaurant can set the price of a Pizza to an integer.  -->
Update the schema and models to create the RestaurantPizza relationship so that:
